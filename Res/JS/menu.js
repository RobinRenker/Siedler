$('#menu_top').hover(function () {
    $('#menu_top').animate({height: menu_top_height_def*2},{queue:false,duration:100});
    $('#menu_side').animate({top: menu_top_height_def*2},{queue:false,duration:100});
    $('#menu_side').animate({height: $(window).height()-(menu_top_height_def*2)},{queue:false,duration:100});
});
...
$('#menu_side').hover(function () {
    $('#menu_side').animate({width: menu_side_width_def*2},{queue:false,duration:100});
});
